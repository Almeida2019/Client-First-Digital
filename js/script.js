...
const translations = {
    en: {
        ...
        'hero.subtitle': 'Affordable Digital Experts for SMEs',
        'hero.headingLead': 'Affordable Digital Solutions for',
        'hero.headingHighlight': 'Growing Businesses',
        'hero.description': 'High-impact AI, web, and marketing services built for small businesses that need results without premium price tags.',
        ...
        'index.contact.tagline': 'Affordable automation, web, and marketing packages built for small and growing businesses.',
        ...
        'index.contact.formTitle': 'Request Your Free Quote',
        ...
        'cta.bookConsultation': 'Get Free Quote',
        ...
        // Services page
        'services.hero.subtitle': 'Affordable Digital Services',
        'services.hero.heading': 'Affordable <span class="gradient-text">Digital Services</span> for Your Business',
        'services.hero.description': 'AI automation, web development, and marketing packages priced for small and growing companies.',
        ...
        'services.core.ai.price': 'From R3,000',
        ...
        'services.core.web.price': 'From R5,000',
        ...
        'services.core.creative.price': 'From R3,500',
        ...
        'services.core.support.price': 'From R1,000/month',
        ...
        'services.integration.zoho.price': 'From R3,000',
        ...
        'services.integration.google.price': 'From R4,000',
        ...
        'services.integration.microsoft.price': 'From R4,500',
        ...
        'services.integration.custom.price': 'From R12,000',
        ...
        'services.additional.ecommerce.price': 'From R5,000',
        ...
        'services.additional.marketing.price': 'From R3,500/month',
        ...
        'services.additional.analytics.price': 'From R4,500',
        ...
        'services.additional.cloud.price': 'From R6,000',
        'services.additional.cloud.timeline': '4-8 weeks migration',

        'services.packages.title': 'Quick-Start Packages',
        'services.packages.subtitle': 'Budget-friendly bundles to launch and grow fast.',
        'packages.webDesign.badge': '3 pages',
        'packages.webDesign.title': 'Web Design',
        'packages.webDesign.desc': 'Launch a modern three-page website with contact form and essential SEO setup.',
        'packages.webDesign.price': 'From R1,500',
        'packages.googleAds.badge': 'Setup',
        'packages.googleAds.title': 'Google Ads',
        'packages.googleAds.desc': 'Campaign setup, conversion tracking, and optimisation for quick lead generation.',
        'packages.googleAds.price': 'From R2,000',
        'packages.metaAds.badge': 'Setup',
        'packages.metaAds.title': 'Meta Ads',
        'packages.metaAds.desc': 'Pixel configuration, creative guidance, and launch campaigns on Facebook & Instagram.',
        'packages.metaAds.price': 'From R1,500',
        'packages.companyProfiles.badge': '7 pages',
        'packages.companyProfiles.title': 'Company Profiles',
        'packages.companyProfiles.desc': 'Professionally written and designed PDF profile that highlights your business strengths.',
        'packages.companyProfiles.price': 'From R1,800',
        'packages.manuals.badge': '7 pages',
        'packages.manuals.title': 'Manuals',
        'packages.manuals.desc': 'Instruction or training manuals with clear structure, diagrams, and print-ready files.',
        'packages.manuals.price': 'From R1,800',
        'packages.emailMarketing.badge': '5 mails',
        'packages.emailMarketing.title': 'Email Marketing',
        'packages.emailMarketing.desc': 'Five beautifully designed campaign emails ready for automation and ongoing nurture.',
        'packages.emailMarketing.price': 'From R3,000',
        'packages.videoEditing.badge': 'New',
        'packages.videoEditing.title': 'Video Editing',
        'packages.videoEditing.desc': 'Short-form edits with captions, motion graphics, and platform-ready exports.',
        'packages.videoEditing.price': 'From R1,500',
        ...
        'services.cta.heading': 'Need an Affordable Project Partner?',
        'services.cta.body': 'Tell us what you need and we\'ll send a customised quote today.',
        ...
        'footer.tagline': 'Get your free quote today!',
    ...
    'pt-pt': {
        ...
        'hero.subtitle': 'Especialistas Digitais Acessíveis para PMEs',
        'hero.headingLead': 'Soluções Digitais Acessíveis para',
        'hero.headingHighlight': 'Negócios em Crescimento',
        'hero.description': 'Serviços de IA, web e marketing com alto impacto pensados para pequenas empresas que precisam de resultados sem preços premium.',
        ...
        'index.contact.tagline': 'Pacotes acessíveis de automação, web e marketing feitos para pequenas e médias empresas.',
        'index.contact.whatsappLabel': 'WhatsApp:',
        'index.contact.emailLabel': 'Email:',
        'index.contact.locationLabel': 'Localização:',
        'index.contact.locationValue': 'Pretória, África do Sul',
        'index.contact.formTitle': 'Peça o Seu Orçamento Gratuito',
        ...
        'cta.bookConsultation': 'Solicitar Orçamento',
        ...
        // Página de Serviços
        'services.hero.subtitle': 'Serviços Digitais Acessíveis',
        'services.hero.heading': 'Serviços <span class="gradient-text">Digitais Acessíveis</span> para o Seu Negócio',
        'services.hero.description': 'Automação, desenvolvimento web e marketing com preços pensados para empresas pequenas e em crescimento.',
        ...
        'services.core.ai.price': 'Desde R3 000',
        ...
        'services.core.web.price': 'Desde R5 000',
        ...
        'services.core.creative.price': 'Desde R3 500',
        ...
        'services.core.support.price': 'Desde R1 000/mês',
        ...
        'services.integration.zoho.price': 'Desde R3 000',
        ...
        'services.integration.google.price': 'Desde R4 000',
        ...
        'services.integration.microsoft.price': 'Desde R4 500',
        ...
        'services.integration.custom.price': 'Desde R12 000',
        ...
        'services.additional.ecommerce.price': 'Desde R5 000',
        ...
        'services.additional.marketing.price': 'Desde R3 500/mês',
        ...
        'services.additional.analytics.price': 'Desde R4 500',
        ...
        'services.additional.cloud.price': 'Desde R6 000',
        'services.additional.cloud.timeline': 'Migração em 4-8 semanas',

        'services.packages.title': 'Pacotes de Arranque Rápido',
        'services.packages.subtitle': 'Opções económicas para lançar e crescer rapidamente.',
        'packages.webDesign.badge': '3 páginas',
        'packages.webDesign.title': 'Web Design',
        'packages.webDesign.desc': 'Lance um website moderno de três páginas com formulário de contacto e SEO essencial.',
        'packages.webDesign.price': 'Desde R1 500',
        'packages.googleAds.badge': 'Configuração',
        'packages.googleAds.title': 'Google Ads',
        'packages.googleAds.desc': 'Configuração da conta, acompanhamento de conversões e optimização para gerar leads rapidamente.',
        'packages.googleAds.price': 'Desde R2 000',
        'packages.metaAds.badge': 'Configuração',
        'packages.metaAds.title': 'Meta Ads',
        'packages.metaAds.desc': 'Configuração do pixel, orientação criativa e campanhas de arranque no Facebook e Instagram.',
        'packages.metaAds.price': 'Desde R1 500',
        'packages.companyProfiles.badge': '7 páginas',
        'packages.companyProfiles.title': 'Perfis Empresariais',
        'packages.companyProfiles.desc': 'Perfil em PDF com redação profissional e design alinhado à sua marca.',
        'packages.companyProfiles.price': 'Desde R1 800',
        'packages.manuals.badge': '7 páginas',
        'packages.manuals.title': 'Manuais',
        'packages.manuals.desc': 'Manuais de instrução ou formação com estrutura clara, diagramas e ficheiros prontos para impressão.',
        'packages.manuals.price': 'Desde R1 800',
        'packages.emailMarketing.badge': '5 emails',
        'packages.emailMarketing.title': 'Email Marketing',
        'packages.emailMarketing.desc': 'Cinco emails criados e desenhados profissionalmente, prontos para automatização e nutrição.',
        'packages.emailMarketing.price': 'Desde R3 000',
        'packages.videoEditing.badge': 'Novo',
        'packages.videoEditing.title': 'Edição de Vídeo',
        'packages.videoEditing.desc': 'Edições curtas com legendas, motion graphics e exportações prontas para as plataformas.',
        'packages.videoEditing.price': 'Desde R1 500',
        ...
        'services.cta.heading': 'Precisa de um Parceiro Digital Acessível?',
        'services.cta.body': 'Conte-nos do que precisa e enviaremos um orçamento personalizado ainda hoje.',
        ...
        'footer.tagline': 'Peça o seu orçamento gratuito hoje mesmo!',
